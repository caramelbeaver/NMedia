...
class PostRepositoryInMemoryImpl : PostRepository {
    ...
    private var posts = listOf(
        Post(
            ...
            content = "Горизонтальные или вертикальные видео? Какой формат ближе: интервью, обзоры, новости? Каких блогеров смотрите чаще всего? Это ещё не все вопросы, ответы на которые нам интересны. Поэтому собрали опрос. Он поможет нашему отделу бренда понять, как улучшить YouTube-канал и сделать видеоконтент интереснее.",
